...
export const Folder = (props) => {
  ...
  return (
    <div>
      ...
      <button style={{margin:"3px",borderRadius:"20px"}} onClick={()=> addFile(props.store, props.id)}>📝</button>
      <button style={{margin:"3px",borderRadius:"20px"}} onClick={()=> addFolder(props.store, props.id)}>📁</button>
